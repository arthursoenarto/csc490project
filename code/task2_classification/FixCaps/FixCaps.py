...
"""
This code is borrowed from https://github.com/Woodman718/FixCaps
It is a modified version of CapsuleNet, also the best practice of classification.
Used to comapre with out other methods
"""
